...
-- Constructor
function LevelModel:new(x, y, width, height, levelContent,transitionState)
    local instance = {
        x = x,
        y = y,
        width = width,
...
function LevelModel:initButtons()
    ...
    self.nextButton = NextButton:new(
        self.imageX + (self.imageWidth / 2),
        self.imageY + self.imageY,
        50,
        50,
        function()
